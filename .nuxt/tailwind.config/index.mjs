...
import postcss from "#build/tailwind.config/postcss.mjs"
...
const config = { theme, corePlugins, plugins, content, darkMode, safelist, postcss, variants, presets, prefix, important, separator, blocklist }
export { config as default, theme, corePlugins, plugins, content, darkMode, safelist, postcss, variants, presets, prefix, important, separator, blocklist }