<template>
  <div class="flex flex-col gap-2 h-full items-center fixed p-3">
    <div class="flex items-center gap-3 px-3 py-2 rounded-xl bg-[#f0f2f4]">
      ...
      <p class="text-[#111418] text-sm font-medium leading-normal">Главная</p>
    </div>
    <div class="flex items-center gap-3 px-3 py-2">
      ...
      <p class="text-[#111418] text-sm font-medium leading-normal">Избранное</p>
    </div>
    <div class="flex items-center gap-3 px-3 py-2">
      <div
        class="text-[#111418]"
