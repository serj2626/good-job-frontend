...
const vacancies = [
  { id: 1, title: "Connect" },
  { id: 2, title: "Fitness" },
  { id: 3, title: "Vue-car-shop" },
  { id: 4, title: "Student journal" },
]
</script>
<template>
  <div class="grid grid-cols-[minmax(0,300px),1fr]">
    <div class="left-sidebar flex flex-col gap-3">
      <section id="profile" class="bg-gray-100 text-center shadow-md p-3">
        ...
        <UButton size="xl" color="teal" variant="solid">Подписаться</UButton>
      </section>
    ...
    <div class="right-block ps-5 flex flex-col gap-8">
      <section id="about" class="bg-gray-100 p-3 rounded-md shadow-2xl">
        ...
        Сфера IT мне очень интересна, Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea ratione distinctio sed quia, beatae aut, harum accusamus nisi magni illum totam ex quaerat inventore deserunt quas. Eius facere sit totam enim quod, saepe voluptate officiis officia eos? Quibusdam, eos mollitia deleniti architecto qui perferendis quae. Nobis aperiam sint delectus modi debitis eius officia. Dolor ullam animi rem, inventore omnis error repellendus hic dicta. Tenetur suscipit tempore similique libero officiis fugiat ab eligendi placeat tempora. Facilis, veniam! Exercitationem blanditiis dignissimos animi voluptate totam, sed perspiciatis, libero est doloribus impedit, iusto voluptatum..
      </section>
      ...
      <section id="vacancies" class="bg-gray-100 p-3 rounded-md shadow-2xl">
        ...
        <div class="flex gap-3 items-center">
          <div class="project text-center flex flex-col gap-3" v-for="item in vacancies" :key="item.id">
            <img src="https://cdn.usegalileo.ai/stability/37c54038-755b-4fdd-bffb-3b5b2334dfcc.png">
            {{ item.title }}
          </div>
        </div>
      ...
      <section id="reviews" class="bg-gray-100 p-3 rounded-md shadow-2xl">
        ...
        <div class="flex w-full flex-row items-start justify-start gap-3 p-4">
          <div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full w-10 shrink-0" style="
          ...
          <div class="flex h-full flex-1 flex-col items-start justify-start">
            <div class="flex w-full flex-row items-start justify-start gap-x-3">
              <p class="text-[#1C160C] text-sm font-bold leading-normal tracking-[0.015em]">
                Alice
              </p>
        ...
        <UPagination size="sm" :model-value="1" :total="100" show-last show-first class="flex justify-center my-2">
        </UPagination>
      </section>
    </div>
  </div>
