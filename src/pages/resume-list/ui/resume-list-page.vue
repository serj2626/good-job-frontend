...
<template>
  <div class="grid grid-cols-[minmax(0,300px),1fr] gap-3 py-3">
    ...
    <section id="search" class="bg-gray-100 text-center shadow-md p-3 flex flex-col gap-2">
      ...
      <USelect color="white" placeholder="Выберите город" variant="outline" :options="['United States', 'Canada', 'Mexico']" />
      <USelect color="white" placeholder="Выберите регион" variant="outline" :options="['Санкт-Петербург', 'Москва', 'Самара', 'Казань']" />
    ...
    <div class="right-block flex flex-col gap-8 shadow-md bg-gray-100 p-3 relative">
      <h3 class="text-[#111418] text-lg text-center font-bold px-4 pb-2 mb-4">Резюме</h3>
